...
public class Office365ThreadedInputStreamConsumer extends ThreadedInputStreamConsumer {
  public Office365ThreadedInputStreamConsumer(Supplier<InputStream> sourceStreamSupplier) {
    super(sourceStreamSupplier);
  }
