...
import org.apache.manifoldcf.crawler.connectors.office365.functionalmanifold.ThreadedBlock;

import java.util.function.Supplier;

public class Office365ThreadedBlock<T> extends ThreadedBlock<T> {
  public Office365ThreadedBlock(Supplier<T> block) {
    super(block);
  }
